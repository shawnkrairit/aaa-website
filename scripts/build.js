  ...
  const html = `${htmlHead("Member Firms", "Our network of leading independent law firms spans all 11 ASEAN member states.", 1)}
    ...
    <section class="bg-navy py-24 lg:py-32">
      <div class="container-narrow text-center">
        <div class="gold-accent mx-auto mb-8"></div>
        <h1 class="text-4xl sm:text-5xl lg:text-6xl font-heading text-white mb-6">Member Firms</h1>
    ...
    <section class="bg-navy py-24 lg:py-32">
      <div class="container-narrow">
        <div class="max-w-3xl">
          ...
          <h1 class="text-4xl sm:text-5xl lg:text-6xl font-heading text-white mb-6">Doing Business in ASEAN</h1>
